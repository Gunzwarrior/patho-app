...
def format_decimal_display(value):
    ...
    specimen_size_cm, Appendix's appendix_size_cm, and Thyroid Cytology's
    liquid_volume_ml already rendered "8.0 cm"/"5.0 mL" today via direct
    {{field}} reference — all three updated to use the new _display
    companion alongside this fix."""
    if value is None:
        return None
